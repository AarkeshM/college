...
const About = () => {
    return (
        <div className="bg-transparent text-white py-20 px-6 md:px-40 mt-0 md:-mt-[200px]">
            ...
            <h1 className="text-center text-5xl font-bold mb-12 text-transparent bg-clip-text bg-gradient-to-r from-[#bd7ce8] via-[#b689eb] to-[#6965ad]">About Us</h1>
